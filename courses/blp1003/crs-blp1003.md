...
|:---:|---|---|
| 1 | [[tp_bilgisayar-aglarina-giris-ve-veri-iletimi\|Bilgisayar Ağlarına Giriş ve Veri İletimi]] | Ağ gereksinimi, veri iletişimi bileşenleri, veri akış yönleri (simplex, half/full-duplex), seri/paralel iletim, bit/sinyal/veri temsili ve Cisco Packet Tracer'a ilk giriş. |
| 2 | [[tp_ag-turleri-topolojiler-ve-ortamlar\|Ağ Türleri, Topolojiler ve İletim Ortamları]] | Kapsamına göre ağlar (LAN, MAN, WAN), dinamik istemci/sunucu ve P2P rolleri, fiziksel/mantıksal topolojiler (yıldız, yol, halka, örgü), iletim ortamları (bakır, fiber, kablosuz) ve yayın biçimleri. |
